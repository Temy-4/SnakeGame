...
public class SnakeGame extends JPanel implements ActionListener, KeyListener {
    ...
    public SnakeGame() {
        ...
        setLayout(null);  // layout nul pour positionner manuellement

        // Création du bouton Recommencer
        restartButton = new JButton("Recommencer");
        restartButton.setBounds(WIDTH / 2 - 80, HEIGHT - 50, 160, 30);
    ...
    public void restartGame() {
        ...
        startGame();
        repaint();
        requestFocusInWindow();  // pour récupérer le focus clavier
    }
